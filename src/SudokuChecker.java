...
public class SudokuChecker {
	...
	public static int [][] checkPuzzle(int[][]puzzle, int[][]solution) {
		...
		//Check across
		int check = checkAcross(puzzle, solution, bad1, bad2);
		if (check == 1) {
			return bad1;
		}
		else if (check == 2) {
		...
		//Check Block
		check = checkBlock(solution, bad2);
		if (check == 1) {
			return bad1;
		}
		else if (check == 2) {
	...
	private static int checkBlock(int[][] solution, int[][] bad2) {
	...
	private static int checkDown(int[][] solution, int[][] bad2) {
		int one;
		int two;
		int three;
		int four;
	...
	private static int checkAcross(int[][] puzzle, int[][] solution, int[][] bad1, int[][] bad2) {
		int one;
		int two;
		int three;
		int four;
